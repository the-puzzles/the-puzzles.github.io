...
const WORDS = {
  ...
  he: {
    3: ['שמש','בית','ילד','כלב','חלב','דבש','לחם','שלג','מים','יום','ערב','בקר','ספר','עיר','גשם','רוח','פרח','עלה'],
    4: ['שמלה','תפוח','כיסא','ילדה','חלון','גינה','מדבר','תפוז','בננה','מלון','לילה','כוכב','מפתח','צלחת','חלום','מחשב'],
    5: ['תמונה','מסעדה','מטריה','מדינה','שולחן','מספרה','תלמיד','עיתון','גלידה','שמיכה'],
  },
}
