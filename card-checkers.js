CATEGORIES.find(c=>c.label==="Classic Games").games.push({
  ...
  "href": "checkers.html",
  "accent": "#e2e8f0",
  "shadow": "rgba(226,232,240,0.15)",
  "iconBg": "#1e2530",
  "gradient": "linear-gradient(135deg,#e2e8f0,#c99a52)",
  "btnBg": "#1e2530",
  "btnColor": "#f1f5f9",
  "playLabel": "Play Checkers",
  "tagline": "Jump your way across the board and clear every last one of your opponent's pieces. Reach the far row and your piece becomes a king.",
  "tagline_he": "קפצו מעל כלי היריב עד שלא נשאר לו אף אחד. הגיעו לשורה הרחוקה וההדום שלכם הופך למלך.",
  "tagline_es": "Salta sobre las piezas rivales hasta acabar con todas. Llega a la fila más lejana y tu ficha se convierte en dama.",
  "rules": [
    "8×8 board — 12 pieces each on the dark squares",
  ...
  "rules_he": [
    "לוח 8×8 — 12 כלים לכל שחקן על המשבצות הכהות",
  ...
  "rules_es": [
    "Tablero 8×8 — 12 piezas cada uno en las casillas oscuras",
